...
class VersionTestCase(unittest.TestCase):
    ...
    def test_env_version_not_set(self):
        ...
        with self.assertRaises(version.JobVersionIsNoMoreSupported):
            version.Version.job_version_check('1.0.1')
    ...
    def test_check_version(self):
        importlib.reload(version)
        self.assertIsNone(version.Version.job_version_check('2.8.7'))
        self.assertIsNone(version.Version.job_version_check('2.88.0'))
        with self.assertRaises(version.JobVersionIsNoMoreSupported):
            version.Version.job_version_check('1.0.1')
            version.Version.job_version_check('1.0.1.dev')
            version.Version.job_version_check('1.0.1-dev')
        ...
        with self.assertRaises(version.JobVersionNotYetSupported):
            version.Version.job_version_check('3.0.0')
            version.Version.job_version_check('11.2.4')
