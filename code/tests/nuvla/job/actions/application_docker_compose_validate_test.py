...
class TestApplicationDockerComposeValidate(unittest.TestCase):
    ...
    def clean_return(self, ret: dict):
    ...
    def test_get_env_to_mute_undefined(self):
        tested_function = ApplicationDockerComposeValidate.get_env_to_mute_undefined
        ...
        for env_name, value in self.clean_return(tested_function(single_service_content)).items():
        ...
        test_return = self.clean_return(tested_function(module_content))
